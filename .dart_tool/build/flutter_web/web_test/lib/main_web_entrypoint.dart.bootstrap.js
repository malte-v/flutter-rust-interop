...
let modulePaths = {
 ...
 "packages/web_test/main": "packages/web_test/main.ddc",
 "packages/web_test/main_web_entrypoint": "packages/web_test/main_web_entrypoint.ddc"
};
...
define("main_web_entrypoint.dart.bootstrap", ["packages/web_test/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:web_test/main_web_entrypoint.dart") {
          // Clear static caches.
