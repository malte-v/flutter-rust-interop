define(['dart_sdk', 'packages/collection/src/utils'], function(dart_sdk, packages__collection__src__utils) {
  ...
  const DelegatingIterable__base = dart.privateName(wrappers, "DelegatingIterable._base");
  wrappers.DelegatingIterable$ = dart.generic(E => {
    ...
    const _base = DelegatingIterable__base;
  ...
  const DelegatingMap__base = dart.privateName(wrappers, "DelegatingMap._base");
  wrappers.DelegatingMap$ = dart.generic((K, V) => {
    ...
    const _base = DelegatingMap__base;
